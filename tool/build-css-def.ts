/**
 * This script generates the /packages/html/functions/StyleDef.ts
 * Which creates css property definitions used by the CreateStyle function
 */
import fs from 'fs';
import {FunctionDesc, PropDesc, ValueType} from '@ticlo/core';
...
fs.writeFile(
  './packages/html/functions/StyleDef.ts',
