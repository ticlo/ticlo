 ...
 * @param {string} name
 */
function BlockBinding(owner, name) {
 ...
 */
RefList.prototype._addLinkSetNodeWrapper = function (val) {
...
BlockBinding.prototype.unListen = function (wrapper) {
    ...
    RefList.prototype.remove.call(this._listeners, wrapper);
...
BlockBinding.prototype.listen = function (listener) {
    if (this._listeners === null) {
        this._listeners = new RefList();
        this._listeners.add = RefList.prototype._addLinkSetNodeWrapper;
        this._listeners.remove = BlockBinding.prototype.unListen.bind(this);
    }
