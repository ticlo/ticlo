...
function _addLinkSetNodeWrapper(val) {
    ...
    this.insertBefore(wrapper, this._head);
    return wrapper;
}
...
BlockBinding.prototype.listen = function (listener) {
    if (this._listeners === null) {
        ...
        this._listeners.addValue = _addLinkSetNodeWrapper;
    }
    let wrapper = /** @type {RefListBindingWrapper} */ this._listeners.addValue(listener);
