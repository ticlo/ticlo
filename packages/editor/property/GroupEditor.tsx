...
import {CustomGroupPropertyReorder, CustomPropertyReorder, GroupPropertyReorder} from './PropertyReorder.ts';
import {MAX_GROUP_LENGTH} from '@ticlo/core/block/FunctonData.ts';
...
export class GroupEditor extends MultiSelectComponent<Props, State, GroupLoader> {
  ...
  renderImpl(): React.ReactNode {
    const {conn, paths, funcDesc, groupDesc, isCustom, funcLib} = this.props;
