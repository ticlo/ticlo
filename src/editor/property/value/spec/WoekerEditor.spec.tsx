...
describe("WorkerEditor", function () {
  ...
  it('expand type editor', async function () {
    ...
    let [component, div] = loadTemplate(
      <WorkerEditor value='' conn={client} desc={desc} onChange={onChange}/>, 'editor');
    ...
    SimulateEvent.simulate(querySingle("//div.ticl-tree-type/span[text()='WorkerEditor']/../div.ticl-tree-arr", document.body), 'click');
